...
- View photos and videos within each album
- Full-screen media viewer with navigation
- Video playback with VLC (broad codec support)
- Device Code Flow authentication (TV-optimized)
- Automatic token refresh
- Optimized for Android TV with Leanback interface
...
**Videos**: MP4, MPEG, QuickTime (MOV), AVI, MKV, WebM, 3GP
